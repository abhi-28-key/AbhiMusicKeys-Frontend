...
import { ArrowLeft, Mail, Lock, Eye, EyeOff, User, Music, Chrome, CheckCircle, AlertCircle } from 'lucide-react';
...
const Signup: React.FC = () => {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!nameValid) {
      return setError('Please enter a valid name (at least 2 characters)');
    }
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="relative flex justify-between items-center p-6">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            {/* Sign In - slightly smaller on mobile */}
            <Button 
              size="sm"
          ...
          <div className="professional-card p-8 bg-white/98 dark:bg-slate-800/98 backdrop-blur-md rounded-3xl shadow-2xl border border-white/30 dark:border-slate-700/30 hover:shadow-3xl transition-all duration-500">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button 
                ...
                disabled={loading || !nameValid || !emailValid || !passwordValid || !confirmPasswordValid}
              >
                {loading ? (
