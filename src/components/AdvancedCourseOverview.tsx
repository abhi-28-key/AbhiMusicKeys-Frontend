        ...
        <main className="flex-1 px-3 sm:px-6 py-6 sm:py-12">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-8 sm:mb-12">
              <h1 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold mb-3 sm:mb-4 text-gray-800 dark:text-white drop-shadow-lg bg-gradient-to-r from-pink-600 via-fuchsia-700 to-pink-600 bg-clip-text text-transparent">
